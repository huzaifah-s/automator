...
export default defineTable({
  ...
  columns: {
    ...
    currency: text({ default: "MYR", label: "Currency", help: "ISO code. MYR unless it was paid abroad." }),
    ...
    source: enumOf(SOURCES, { default: "manual", label: "Source", help: "How the row arrived." }),
    reference: text({
      nullable: true,
      label: "Reference",
      help: "Invoice number, bank reference — whatever identifies it elsewhere.",
    }),
    needs_review: bool({ default: false, label: "Needs review", help: HELP.needsReview }),
